...
@interface MPCarDataViewController ()
@property (nonatomic, strong)UIImagePickerController *imagePicker;

@end

@implementation MPCarDataViewController
...

{
    ...
    NSString *post2=[NSString stringWithFormat:@"make=%@",txtText.text];
    ...
    [cerere2 setURL:[NSURL URLWithString:@"http://thewebcap.com/dev/ios/model.php"]];
    ...
    models=[replyString2 componentsSeparatedByString:@"*~*"];
...
- (IBAction)doneButtonClicked:(id)sender {
    ...
    NSMutableURLRequest *cerere2 = [[NSMutableURLRequest alloc] init];
    [cerere2 setURL:[NSURL URLWithString:@"http://thewebcap.com/dev/ios/registration.php?tip=masina"]];
    [cerere2 setHTTPMethod:@"POST"];
    [cerere2 setValue:postLength2 forHTTPHeaderField:@"Content-Length"];
    [cerere2 setValue:@"application/x-www-form-urlencoded" forHTTPHeaderField:@"Content-Type"];
    [cerere2 setHTTPBody:postData2];
